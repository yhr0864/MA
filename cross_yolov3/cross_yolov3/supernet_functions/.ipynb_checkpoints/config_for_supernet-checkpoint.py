...
CONFIG_SUPERNET = {
    ...
    'lookup_table' : {
        ...
        'path_to_lookup_table_head26' : './supernet_functions/lookup_table_head26.txt',
        'path_to_lookup_table_head13' : './supernet_functions/lookup_table_head13.txt',
        'path_to_lookup_table_fpn' : './supernet_functions/lookup_table_fpn.txt',
