    ...
    for idx, module in enumerate(loose_model.module_list):
        if isinstance(module, ConvBNRelu):
            if 2 <= idx <= 17:
                ...
                # return
                compact_conv, loose_conv = compact_model.module_list[idx][0], module[0]
                # if idx == 4:
...
#                     print(loose_conv.weight.data[0][0])
                ...
                # BN params
                cpmpact_bn, loose_bn = compact_model.module_list[idx][1], module[1]
                ...
                if len(compact_model.module_list[idx]) > 1:
                    compact_model.module_list[idx][1].weight.data = module[1].weight.data.clone()
                    compact_model.module_list[idx][1].bias.data = module[1].bias.data.clone()
                ...
                if idx == 0:
                    ...
                    compact_conv.bias.data = loose_conv.bias.data[:, in_channel_idx, :, :].clone()
