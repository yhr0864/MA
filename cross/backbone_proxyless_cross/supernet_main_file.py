...
#SBATCH --job-name=yhr_cross_delay
...
import sys
sys.path.append("/pfs/data5/home/kit/tm/px6680/haoran/backbone_proxyless_cross/")
...
parser.add_argument("--start_quant", type=int, default=95,
                    help="Set the epoch from which start quantizing the model")
parser.add_argument("--train_thetas_from_the_epoch", type=int, default=100,
