...
class QuanConv2d(building_blocks.layers.misc.Conv2d):
    def __init__(self, m: building_blocks.layers.misc.Conv2d, quan_w_fn=None, quan_a_fn=None):
        assert type(m) == building_blocks.layers.misc.Conv2d
