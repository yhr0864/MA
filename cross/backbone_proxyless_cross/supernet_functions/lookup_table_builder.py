...
CANDIDATE_BLOCKS_BACKBONE = ["ir_k3_re_e1", "ir_k3_re_e3", "ir_k3_re_e6",
                             "ir_k5_re_e1", "ir_k5_re_e3", "ir_k5_re_e6",
                             "ir_k7_re_e1", "ir_k7_re_e3", "ir_k7_re_e6", "skip"]
# CANDIDATE_BLOCKS_HEAD = ["ir_k3_re", "ir_k3_r2_re", "ir_k5_re", "ir_k5_r2_re", "skip"]
CANDIDATE_BLOCKS_HEAD = ["ir_k3_re_e1", "ir_k3_re_e3", "ir_k3_re_e6",
                         "ir_k5_re_e1", "ir_k5_re_e3", "ir_k5_re_e6", "skip"]
# CANDIDATE_BLOCKS_FPN = ["ir_k3_re", "ir_k3_r2_re", "ir_k3_r3_re",
#                         "ir_k5_re", "ir_k5_r2_re", "ir_k5_r3_re",
#                         "none", "skip"]
CANDIDATE_BLOCKS_FPN = ["ir_k3_re_e1", "ir_k3_re_e3", "ir_k3_re_e6",
                        "ir_k5_re_e1", "ir_k5_re_e3", "ir_k5_re_e6",
                        "skip", "none"]
SEARCH_SPACE_BACKBONE = OrderedDict([
    ...
    ("input_shape", [(16, 208, 208),
                     (32, 104, 104), (64, 52, 52), (128, 52, 52),
                     (128, 26, 26), (256, 26, 26), (256, 26, 26),
                     (256, 26, 26), (512, 26, 26), (512, 13, 13),
                     (1024, 13, 13)]),
...
class LookUpTable:
    def __init__(self, candidate_blocks_backbone=None,
        ...
        self.lookup_table_num_ops_fpn = None
        ...
        if calculate_num_ops:
            self._creat_num_ops_tables(write_to_file=CONFIG_SUPERNET['lookup_table']['path_to_num_ops_table'],
                                       ...
                                       write_to_file_fpn=CONFIG_SUPERNET['lookup_table']['path_to_num_ops_fpn'])
    ...
    def _create_from_operations(self, cnt_of_runs, write_to_file=None,
                                write_to_file_head26=None, write_to_file_head13=None, write_to_file_fpn=None):
    ...
    def _creat_num_ops_tables(self, write_to_file=None,
        ...
        self.lookup_table_num_ops_head13 = self._calculate_num_ops(self.head_layers,
                                                                   ...
                                                                   self.layers_parameters_head13,
                                                                   self.layers_input_shapes_head13)
        self.lookup_table_num_ops_fpn = self._calculate_num_ops(self.fpn_edges,
                                                                self.lookup_table_operations_fpn,
                                                                self.layers_parameters_fpn,
                                                                self.layers_input_shapes_fpn)
    ...
    def _create_from_file(self, path_to_file, path_to_file_head26, path_to_file_head13, path_to_file_fpn):
