...
def run():
    ...
    parser.add_argument("-w", "--weights", type=str, default="./best_yolov3.pth", help="Path to weights or checkpoint file (.weights or .pth)")
    ...
    # model = torch.load('./yolov3-EagerModeQt.pth')
