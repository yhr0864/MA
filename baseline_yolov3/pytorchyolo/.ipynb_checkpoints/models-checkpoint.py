...
def create_modules(module_defs, qt):
    """
...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path, qt):
        super(Darknet, self).__init__()
        self.module_defs = parse_model_config(config_path)
        self.hyperparams, self.module_list = create_modules(self.module_defs, qt)
...
def load_model(model_path, qt=False, weights_path=None):
    ...
    model = Darknet(model_path, qt).to(device)
