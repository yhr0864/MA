...
from detect import _create_data_loader
...
parser.add_argument("-w", "--weights", type=str, default="./best_yolov3_prune.pth", help="Path to weights or checkpoint file (.weights or .pth)")  
...
def track():
    ...
    # get detections
    model = load_model(args.model, weights_path=args.weights)
    ...
    with tqdm(total=len(seq_list)) as pbar:
        for i, seq in enumerate(seq_list):
            ...
            if i == 39:
                ...
                dataloader = _create_data_loader(image_folder, args.batch_size, args.img_size, args.n_cpu)
